...
export default function FolderItem({ folderName, sampleCount, isOpen, onClick }) {
  return (
    <div
    ...
    >
      ...
      <div className="absolute inset-0 flex items-center justify-center z-20">
        {isOpen ? (
          <FolderOpen className="w-9 h-9 text-gray-800" strokeWidth={1.5} />
        ) : (
          <Folder className="w-9 h-9 text-gray-800" strokeWidth={1.5} />
        )}
      </div>
