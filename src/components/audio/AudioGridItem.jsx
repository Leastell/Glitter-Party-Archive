...
export default function AudioGridItem({
    audioBreak,
    onDownload,
    isPlaying,
    onPlay,
    ...
    const hasLongSticker =
        audioBreak.sticker === "long" ||
        ...
        >
            ...
            {hasNewSticker && (
                <div className="absolute -top-3 -right-3 z-30 pointer-events-none">
                    <div className="relative">
                        <img
                            src={getStorageUrl(ASSET_PATHS.stickerNew)}
                            alt="New"
                        ...
                        <div className="absolute inset-0 flex items-center justify-center transform rotate-12">
                            <span className="font-heavy text-xs text-black">
                                NEW
                            </span>
                        </div>
                    </div>
            ...
            {hasLongSticker && (
                <div className="absolute -top-3 -right-3 z-30 pointer-events-none">
                    <div className="relative">
                        <img
                            src={getStorageUrl(ASSET_PATHS.stickerLong)}
                            alt="Long"
                            className="w-12 h-12 transform rotate-12"
                        />
                        <div className="absolute inset-0 flex items-center justify-center transform rotate-12">
            ...
            >
                ...
                <div className="text-left">
                    <p
                        ...
                        onDoubleClick={() =>
                            !isLocked &&
                            onPlay(isPlaying ? null : audioBreak.id)
                        }
                    >
            ...
            {/* Playing Indicator */}
            {isPlaying && !isLocked && (
                <div className="absolute top-2 right-2 w-1 h-1 bg-red-500 rounded-full animate-ping z-30"></div>
            )}
        </motion.div>
    );
}
